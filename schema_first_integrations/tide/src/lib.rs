...
use async_graphql::schema_first::schema::Schema;
use async_graphql::{ObjectType, ParseRequestError, SubscriptionType};
...
pub fn endpoint(schema: Schema) -> Endpoint {
    Endpoint {
        schema,
...
#[async_trait]
impl<TideState> tide::Endpoint<TideState> for Endpoint
where
